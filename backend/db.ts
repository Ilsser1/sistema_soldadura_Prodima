...
export class IndustrialDatabase {
  ...
  public borrarTodo(usuario_ip: string, req_user: string): { mensaje: string } {
    this.data.tecnicos = [];
    this.data.maquinas = [];
  ...
  public restablecerEjemplos(usuario_ip: string, req_user: string): { mensaje: string } {
    this.data.tecnicos = [...INITIAL_TECNICOS];
    this.data.maquinas = [...INITIAL_MAQUINAS];
    this.data.asignaciones = [...INITIAL_ASIGNACIONES];
    this.data.mantenimientos = [...INITIAL_MANTENIMIENTOS];
