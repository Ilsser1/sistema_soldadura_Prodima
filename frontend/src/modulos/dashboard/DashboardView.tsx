...
import { DashboardStats, Alerta, Usuario, Asignacion, Mantenimiento } from '../../../../shared/types';
import { useTheme } from '../../context/ThemeContext';
import { HardHat, Cpu, CheckCircle2, Link2, Wrench, AlertOctagon, Clock, FileCheck, FileWarning, FileX, Bell, TrendingUp, Layers, ArrowRight, RefreshCw } from 'lucide-react';
import {
  ResponsiveContainer,
  BarChart,
  Bar,
